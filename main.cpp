...
void coverDisplay()
{
    ...
    glColor3f(0., 0., 1);
    drawText("VIVEKANANDA COLLEGE OF ENGINEERING AND TECHNOLOGY", -0.48f, 0.8f, 0.0f);
    glColor3f(0.7, 0., 1.);
    ...
    glColor3f(0.3, 0, 0.6);
    drawText("SHASHANK RAO P                         4VP20CS084", -0.4f, -0.2f, 0.0f);
    glColor3f(0.3, 0, 0.6);
    drawText("UNDER THE GUIDANCE OF:", -0.2f, -0.6f, 0.0f);
    glColor3f(0.6, 0.2, 0.7);
    drawText("PROF.RADHIKA", -0.15f, -0.8f, 0.0f);
